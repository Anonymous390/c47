  ...
  play(){
    ...
    if(allPlayers !== undefined){
      ...
      for(var plr in allPlayers){
        ...
        if(player.distance === 0 && player.index !== null){
          player.initialUpdate();
          console.log("hr" + player.horizontalDistance)
          player.horizintalDistance = player.horizontalDistance + 200;
          x = player.horizontalDistance;
          console.log("if " + x);
        }else{
